...
df["RATING"] = df["RATING"].fillna(2.5) #The df["column name"].fillna(specified value) method fills the null values of a column with a specified value.
...
df["APPROXIMATE COST FOR 2 PEOPLE"] = df["APPROXIMATE COST FOR 2 PEOPLE"].fillna(0)
